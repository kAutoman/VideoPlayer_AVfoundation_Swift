...
def arguments(argsval):
    ...
    parser.add_argument('-mc', '--max_commits', type=int, default=3,
    ...
    parser.add_argument('-un', '--user_name', type=str, required=False, default="kAutoman",
                        help="""Overrides user.name git config.
                        If not specified, the global config is used.""")
    parser.add_argument('-ue', '--user_email', type=str, required=False, default="automan990923@gmail.com",
